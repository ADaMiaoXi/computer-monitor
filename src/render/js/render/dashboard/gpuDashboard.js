import {electronStore, openDashboard} from '../index.js'
...
const displayGpuDashboard = async dashboard => {
    ...
    div.innerHTML = `<iframe src="./dashboard/gpuDashboard.html" frameborder="0"></iframe>`
    div.firstElementChild.setAttribute('electronStore', electronStore)
